...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2022 at 09:21 AM
...
('2022-12-01', '', '123456788', '3'),
('2022-12-03', 'note', '123456777', '3'),
('2022-12-01', 'note', '123456788', '2'),
('2022-12-06', 'note', '123456788', '2'),
('2022-12-06', 'note', '123456788', '3'),
...
ALTER TABLE `appointment`
  ADD PRIMARY KEY (`Date`,`PHN`),
  ADD KEY `Time` (`Time`,`Type1`,`SSN`);
...
ALTER TABLE `prescription`
  ...
  ADD KEY `DIN` (`DIN`),
  ADD KEY `Date` (`Date`,`Workflow_state`,`QUANTITY`);

--
-- Indexes for table `vaccine_record`
--
ALTER TABLE `vaccine_record`
  ADD PRIMARY KEY (`DIN`,`Date`,`DoseNumber`),
  ADD KEY `SSN` (`SSN`);
